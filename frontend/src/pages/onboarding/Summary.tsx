...
export default function Summary() {
  ...
  const finish = () => {
    // TODO: Send onboardingData to backend
    navigate("/");
  };
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-indigo-500 via-purple-500 to-purple-600">
      <div className="bg-white p-10 rounded-2xl shadow-2xl w-full max-w-2xl mx-4">
        ...
        <div className="flex gap-4">
          ...
          <button
            onClick={finish}
            className="flex-1 p-3.5 bg-gradient-to-r from-green-500 to-emerald-600 text-white rounded-lg text-base font-semibold hover:-translate-y-0.5 transition-transform shadow-lg"
          >
            ✓ Finish
          </button>
        </div>
